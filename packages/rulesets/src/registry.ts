...
export const RULE_SETS: readonly RuleSetInfo[] = [
  ...
  },
  {
    ...
    description: "The full expansion: commodities, city improvements, the event die, barbarians, knights, all 24 progress cards, metropolises, city walls and the merchant; second placement is a city; 13 points to win.",
    seats: { min: 2, max: 4 },
